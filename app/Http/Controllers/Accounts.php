...
<div class="d-flex align-items-center col-actions">
  ...
  <a href="' . URL('/PettyDelete/' . $row->PettyMstID) . '"><i class="bx bx-trash align-middle me-1 text-secondary"></i></a>
    ...
    public  function PettyCashCreate()
    {
        ...
        $chartofaccount = DB::table('chartofaccount')->where('Code', 'A')->get();
    ...
    public  function JV()
    {
        ...
        $data = DB::table('voucher_master')
            ...
            ->where('VoucherCodeID', 7)
            ->get();


        Session::put('VHNO', $d['VocherCode'] . date('ym') . $data[0]->vhno);
...
<a href="' . URL('/VoucherDelete/' . $row->VoucherMstID) . '"><i class="font-size-18 mdi mdi-trash-can-outline align-middle me-1 text-secondary"></i></a>
    ...
    public  function VoucherCreate($vouchertype)
    {
        ...
        $d = array(
            'VocherTypeID' => $voucher_type[0]->VoucherTypeID,
            'VocherCode' => $vouchertype,
            'VHDate' => date('Y-m-d')
        );
...
';
    ...
    public  function Ajax_VHNO(request $request)
    {
        ...
        Session::put('VHNO', $d['VocherCode'] . substr($d['VHDate'], 2, 6) . $data[0]->vhno);
    ...
    public function CashbookReport()
    {
        ...
        $chartofaccount = DB::table('chartofaccount')
            ->whereIn('Category', ['CASH', 'CARD', 'BANK'])
            ->get();
    ...
    public  function BalanceSheet1(request $request)
    {
        ...
        $chartofaccounta = DB::select('SELECT CODE,ChartOfAccountID,ChartOfAccountName from chartofaccount where  CODE = "A"  and Level=2  ');
...
<a href="' . URL('/DeliveryChallanDelete/' . $row->ChallanMasterID) . '"><i class="font-size-18 mdi mdi-trash-can-outline align-middle me-1 text-secondary"></i></a>
    ...
    public  function SaleInvoiceViewPDF2($id)
    {
        $pagetitle = 'Sales Invoice';
...
<a href="' . URL('/PurchasePaymentEdit/' . $row->PurchasePaymentMasterID) . '"><i class="font-size-18 mdi mdi-pencil align-middle me-1 text-secondary"></i></a>
...
<a href="' . URL('/PurchasePaymentDelete/' . $row->PurchasePaymentMasterID) . '"><i class="font-size-18 mdi mdi-trash-can-outline align-middle me-1 text-secondary"></i></a>
    ...
    public function PurchasePaymentEdit($id)
    {
        ...
        $purchasepayment_master = DB::table('purchasepayment_master')->where('PurchasePaymentMasterID', $id)->get();
        $purchasepayment_detail = DB::table('v_purchase_payment_detail')->where('PurchasePaymentMasterID', $id)->get();




        return view('ebooks.purchase_payment_edit', compact('chartofacc', 'supplier', 'pagetitle', 'payment_mode', 'purchasepayment_master', 'purchasepayment_detail'));
    }
    ...
    public function PurchasePaymentUpdate(request $request)
    {
        ...
        $id = DB::table('purchasepayment_master')->where('PurchasePaymentMasterID', $request->PurchasePaymentMasterID)->update($payment_master);



        $id = DB::table('purchasepayment_detail')->where('PurchasePaymentMasterID', $request->PurchasePaymentMasterID)->delete();
        $id2 = DB::table('journal')->where('PurchasePaymentMasterID', $request->PurchasePaymentMasterID)->delete();
        ...
        for ($i = 0; $i < count($request->InvoiceMasterID); $i++) {
            ...
            if ($request->Amount[$i] > 0) {
                ...
                // A/C PAYABLE
                $ac_payable = array(
                    'VHNO' => 'BILLPAY-' . $request->PurchasePaymentMasterID,
                    ...
                    'Dr' => $request->Amount[$i],
                    'Narration' => 'Payment made with payment refno ' . $request->PurchasePaymentMasterID . '',
                    'Trace' => 515
                );
        ...
        return redirect('PurchasePayment')->with('error', 'Update successfully')->with('class', 'success');
    }
    ...
    public function SalesmanSave(request $request)
    {
        ...
        $id = DB::table('salesman')->insertGetId($data);
    ...
    public function SalesmanEdit($id)
    {
        ...
        $salesman = DB::table('salesman')->where('SalesmanID', $id)->get();
    ...
    public function SalesmanUpdate(request $request)
    {
        ...
        $id = DB::table('salesman')->where('SalesmanID', '=', $request->SalesmanID)->update($data);
    ...
    public  function SalesmanDelete($id)
    {
        ...
        $id = DB::table('salesman')->where('SalesmanID', $id)->delete();
