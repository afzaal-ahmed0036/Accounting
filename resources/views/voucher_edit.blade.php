           ...
           <?php $no = $key+1; ?>
            ...
            <tr  class="bg-light border-1 border-light" >
              ...
              <td>
               ...
               <td> <select name="SupplierID[]" id="SupplierID_{{$no}}" class="  form-select select2 " onchange="ajax_balance(this.value);" style="width: 100% !important;">
              ...
              <td> <select name="PartyID[]" id="PartyID_{{$no}}" class=" form-select select2" onchange="ajax_balance(this.value);" style="width: 100% !important;">
                <option value="">Select Supplier</option>
...
$(".addmore").on('click',function(){
  ...
  html += '<td><select name="PartyID[]" id="PartyID_'+i+'"  onchange="ajax_balance(this.value);" class="form-select select2" style="width: 100% !important;"> <option value="">Select Party</option>@foreach ($party as $key => $value) <option value="{{$value->PartyID}}">{{$value->PartyName}}</option>@endforeach</select></td>';
