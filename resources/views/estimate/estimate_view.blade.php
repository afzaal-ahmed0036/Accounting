                        ...
                        <div class="pcs-template-body">
                                ...
                                <tbody>
                                    <tr>
                                        <td style="vertical-align: top; width:50%;">
                                            <div><span
                                                    class="style1 pcs-entity-title"><strong>{{ $company[0]->Name }}</strong></span>
                                            </div>
                                        ...
                                        <td style="vertical-align: top; text-align:right;width:50%;">
                                            ...
                                            <span class="pcs-entity-title style1">{{ $company[0]->EstimateInvoiceTitle }}
                                    ...
                                    <tr>
                                        <td style="width:60%;vertical-align:bottom;word-wrap: break-word;">
                                            <div style="clear:both;width:50%;margin-top: 20px;">
                                                <label style="font-size: 16pt;" class="pcs-label"
                                                    id="tmp_shipping_address_label">Estimate To</label>
                                                <br>
                                                <span id="tmp_shipping_address"><strong><span class="text-danger"
                                                            id="zb-pdf-customer-detail"><a
                                                                href="#">{{ $estimate[0]->PartyID == 1 ? $estimate[0]->WalkinCustomerName : $estimate[0]->PartyName }}</a></span></strong><br>
                                                    <br>
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="text-align:right;">
                                                            <span id="tmp_entity_date">{{ $estimate[0]->Date }}</span>
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="text-align:right;"><span
                                                                id="tmp_ref_number">{{ $estimate[0]->ExpiryDate }}</span>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td
                                                        ...
                                                        <td style="text-align:right;">
                                                            <span
                                                                id="tmp_ref_number">{{ $estimate[0]->ReferenceNo }}</span>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                    ...
                                    <tr style="height:32px;">
                                        ...
                                        <td width="33%" bgcolor="#CCCCCC"
                                            ...
                                            style="padding: 5px 10px 5px 20px;width: ;text-align: left;"><span
                                                ...
                                                style="padding: 5px 10px 5px 20px;width: ;text-align: left;"><strong>Item
                                                    Name </strong></span></td>
                                        <td bgcolor="#CCCCCC" class="pcs-itemtable-breakword pcs-itemtable-header"
                                            ...
                                            <span class="pcs-itemtable-breakword pcs-itemtable-header"
                                                style="padding: 5px 10px 5px 5px;width: 11%;text-align: right;"><strong>Description</strong></span>
                                        </td>
                                        <td width="10%" bgcolor="#CCCCCC"
                                            class="pcs-itemtable-breakword pcs-itemtable-header" id=""
                                        ...
                                        <tr class="breakrow-inside breakrow-after">
                                            ...
                                            <td valign="top" style="padding: 10px 0px 10px 20px;" class="pcs-item-row">
                                                <span class="pcs-item-row" style="padding: 10px 0px 10px 20px;">
                                                    {{ $value->ItemName }} </span></td>
                                            <td valign="top" class="pcs-item-row" style="padding: 10px 0px 10px 20px;">
                                                <div>
                                                    <div> <span style="white-space: pre-wrap;word-wrap: break-word;"
                                                            class="pcs-item-desc"
                                                            id="tmp_item_description">{{ $value->Description }} </span>
                                                    </div>
                                                </div>
                                            </td>
                                        ...
                                        <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                            <tr>
                                                <td width="50%"><strong>Description :</strong>
                                                    {{ $estimate[0]->DescriptionNotes }}</td>
                                            </tr>
                                            <tr>
                                                <td width="50%"><strong>Customer Notes :
                                                    </strong>{{ $estimate[0]->CustomerNotes }}</td>
                                            </tr>
                                        </table>
                                    </div>
                                </div>
                                    ...
                                    <table class="pcs-totals" cellspacing="0" border="0" width="100%">
                                        <tbody>
                                            ...
                                            <tr class="pcs-balance">
                                                ...
                                                <td height="25" align="right" valign="middle" id="tmp_total"
                                                    style="width:120px;;padding: 10px 10px 10px 5px;">
                                                    <div align="right"><b>{{ $estimate[0]->Shipping }}</b></div>
                                                </td>
                                            </tr>
                            ...
                            <div style="width: 100%;margin-top: 10px;">
                                <table cellspacing="0" border="0" width="100%">
                                    <tbody>
                                        <tr class="bg-light" style="height: 30px;">
                                            <td width="10%" class="total-in-words-label text-align-right  ">Total In
                                                Words:</td>
                                            <td width="90%" class="total-in-words-value text-align-left "><i><b>
                                                        {{ convert_number_to_words($estimate[0]->Total) }} only </b></i>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                                        <td width="50%">&nbsp;</td>
                                        <td width="50%" rowspan="2" valign="top">@include('signature.signature')
                                        </td>
                                    </tr>
                                    <tr>
                                        <td width="50%">&nbsp;</td>
