                                            ...
                                            <div class="mb-3 row">
                                                ...
                                                <div class="col-sm-9">
                                                    ...
                                                    <input type="text" id="first-name" class="form-control"
                                                        name="ItemName" value="{{ $item[0]->ItemName }}">
                                                    ...
                                                    <select name="Unit" id="Unit" class="form-select">
                                                        ...
                                                        @foreach ($unit as $value)
                                                            <option value="{{ $value->UnitName }}"
                                                                {{ $value->UnitName == $item[0]->UnitName ? 'selected=selected' : '' }}>
                                            ...
                                            <div class="mb-3 row">
                                                ...
                                                <div class="col-sm-9">
                                                    <select name="Taxable" id="Taxable" class="form-select">
                                                        ...
                                                        <option value="No"
                                                            {{ $item[0]->Taxable == 'No' ? 'selected=selected' : '' }}>No
                                                        </option>
                                                        <option value="Yes"
                                                            {{ $item[0]->Taxable == 'Yes' ? 'selected=selected' : '' }}>Yes
                                                        </option>
                                            ...
                                            <div class="mb-1 row">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text" id="Percentage" class="form-control"
                                                        name="Percentage" value="{{ $item[0]->Percentage }}">
                                                </div>
                                            </div>
                                        ...
                                        <div class="row mt-5">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="mb-3 row">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <input type="text" id="first-name" class="form-control"
                                                            name="SellingPrice" value="{{ $item[0]->SellingPrice }}"
                                                            required="">
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="mb-3 row">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <input type="text" id="first-name" class="form-control"
                                                            name="CostPrice" value="{{ $item[0]->CostPrice }}"
                                                            required="">
                                                    </div>
                                                </div>
