            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            <h4 class="mb-sm-0 font-size-18">Add Project Details</h4>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <form class="row g-3 mb-6" action="{{ url('Project/Save') }}" method="POST">
                                    @csrf
                                    ...
                                    <div class="col-12 gy-6">
                                        <div class="form-floating">
                                            <textarea name="overview" class="form-control" id="floatingProjectOverview" placeholder="Leave a comment here"
                                                style="height: 100px"></textarea><label for="floatingProjectOverview">Project
                                                overview</label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-6 col-md-4 gy-6">
                                        <div class="form-floating">
                                            <input name="budget" class="form-control" id="floatingInputBudget"
                                                type="number" step="0.001" placeholder="Budget">
                                    ...
                                    <div class="col-12 gy-6">
                                        <div class="row g-3 justify-content-end">
                                            ...
                                            <div class="col-auto"><button type="submit"
                                                    class="btn btn-primary px-5 px-sm-15">Create</button></div>
                                        </div>
                                    </div>
                                </form>
                            </div>
