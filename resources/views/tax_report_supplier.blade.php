 ...
 <div class="container-fluid">
  ...
  <div class="card">
      <div class="card-body">
          ...
          <form action="{{URL('/TaxReportSupplier1')}}" method="post" name="form1" id="form1"> {{csrf_field()}} 
...
<script>
  $('#pdf').click(function(){
   ...
   $('#form1').attr('action', '{{URL("/TaxReportSupplier1PDF")}}');
  ...
  $('#online').click(function(){
        $("#form1").removeAttr("target");
     $("#form1").removeAttr("action");
   $('#form1').attr('action', '{{URL("/TaxReportSupplier1")}}');
