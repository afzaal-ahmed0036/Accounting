...
<textarea name="Narration_mst" id="Narration" cols="30" rows="5" class="form-control " placeholder="Narration" required=""></textarea>
          ...
          <tbody>
            <tr  class="bg-light border-1 border-light" >
              ...
              <td style="width:300px;">
                 ...
                 <select name="ChartOfAcc2[]" id="ItemID0_1" class="form-select form-control-sm select2   " style="width:400px;" required="">
