...
<div class="main-content">
    <div class="page-content">
        <div class="container-fluid">
            ...
            <form action="{{URL('/DeliveryChallanSave')}}" method="post" class="custom-validation">
...
<div class="mb-1 row " id="WalkinCustomer">
 ...
 <input type="text"  class="form-control" name="WalkinCustomerName" value="" placeholder="Walkin cusomter" id="1WalkinCustomerName" >
                ...
                <div class="mb-1 row">
                  ...
                  <div class="col-sm-9">
                    <input type="text" id="first-name" class="form-control" name="PlaceOfSupply" value="">
              ...
              <div class="col-md-6">
                <div class="col-12">
                  <div class="mb-1 row">
                    <div class="col-sm-3">
                      <label class="col-form-label text-danger" for="first-name">Delivery Note #</label>
                    </div>
                    <div class="col-sm-9">
                      <input type="text" id="first-name" class="form-control" name="ChallanNo" value="DC-{{$challan_master[0]->ChallanMasterID}}">
                    </div>
                  </div>
                </div>
                <div class="col-12">
                  <div class="mb-1 row">
                    ...
                    <div class="col-sm-9">
                      <div class="input-group" id="datepicker21">
                        <input type="text" name="ChallanDate" autocomplete="off" class="form-control" placeholder="yyyy-mm-dd" data-date-format="yyyy-mm-dd" data-date-container="#datepicker21" data-provide="datepicker" data-date-autoclose="true" value="{{date('Y-m-d')}}">
                    ...
                    <div class="col-sm-9">
                      <select name="ChallanType" id="ChallanType" class="form-select">
                        <?php foreach ($challan_type as $key => $value) : ?>
                          <option value="{{$value->ChallanTypeName}}">{{$value->ChallanTypeName}}</option>
                        <?php endforeach ?>
                ...
                <div class="col-12">
                  <div class="mb-1 row">
                    ...
                    <div class="col-sm-9">
                      <input type="text" id="first-name" class="form-control" name="ReferenceNo" value="">
                    </div>
                  </div>
                </div>
              </div>
                                ...
                                <form class="form-inline">
                                    <div class="form-group mt-1">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" id="subTotal" name="SubTotal" placeholder="Subtotal" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;" value="0">
                                        </div>
                                    </div>
                                    <div class="form-group mt-1">
                                    ...
                                    <div class="form-group mt-1">
                                        ...
                                        <div class="input-group">
                                            <span class="input-group-text bg-light">{{session::get('Currency')}}</span>
                                            <input type="number" name="Total" class="form-control" step="0.01" id="totalafterdisc" readonly placeholder="Total" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;" value="0">
                                        </div>
                                    </div>
                                    <div class="form-group mt-1">
                                        <label>Tax: &nbsp;</label>
