...
<div class="main-content">
 ...
 <div class="mb-1 row">
                  ...
                  <div class="col-sm-9">
                  <select name="PartyID" id="PartyID" class="form-select" required="">
...
<div class="mb-1 row">
   ...
   <div class="col-md-6">  
    <div class="col-12">
                <div class="mb-1 row">
                  <div class="col-sm-3">
                    <label class="col-form-label text-danger" for="first-name">Challan Note #</label>
                  </div>
                  <div class="col-sm-9">
                    <input type="text" id="first-name" class="form-control" name="ChallanNo" value="{{$challan_master[0]->ChallanNo}}" disabled="" >
                  </div>
                </div>
              </div>
              <div class="col-12">
  ...
  <input type="text" name="ChallanDate"  autocomplete="off" class="form-control" placeholder="yyyy-mm-dd" data-date-format="yyyy-mm-dd" data-date-container="#datepicker21" data-provide="datepicker" data-date-autoclose="true" value="{{$challan_master[0]->ChallanDate}}">
  <span class="input-group-text"><i class="mdi mdi-calendar"></i></span>
                ...
                <div class="mb-1 row">
                  ...
                  <?php foreach ($challan_type as $key => $value): ?>
                    <option value="{{$value->ChallanTypeName}}" {{($value->ChallanTypeName== $challan_master[0]->ChallanType) ? 'selected=selected':'' }}>{{$value->ChallanTypeName}}</option>
                  <?php endforeach ?>
               ...
               <div class="col-12">
                <div class="mb-1 row">
                  <div class="col-sm-3">
                    <label class="col-form-label text-danger" for="first-name">Reference(PLO) #</label>
                  </div>
                  <div class="col-sm-9">
...
<td><input type="text" name="Description[]" id="Description_1" class=" form-control " value="{{$value1->Description}}" ></td>
...
<!-- end of for each -->
  ...
  <label for="" class="mt-2">Description</label>
                   <textarea class="form-control" rows='5' name="DescriptionNotes" id="note" placeholder="Description notes if any.">{{$challan_master[0]->DescriptionNotes}}</textarea>
                                ...
                                <form class="form-inline">
                                    <div class="form-group mt-1">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" id="subTotal" name="SubTotal" placeholder="Subtotal" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;" value="{{$challan_master[0]->SubTotal}}">
                                        </div>
                                    </div>
                                    <div class="form-group mt-1">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control"   id="discountper" name="DiscountPer" placeholder="Tax" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;" value="{{$challan_master[0]->DiscountPer}}"> 

                                            <span class="input-group-text bg-light">{{session::get('Currency')}}</span>

                                            <input type="text" name="DiscountAmount" class="form-control" id="discountAmount" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;" value="{{$challan_master[0]->DiscountAmount}}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group mt-1">
                                        ...
                                        <div class="input-group">
                                            <span class="input-group-text bg-light">{{session::get('Currency')}}</span>
                                            <input type="number" name="Total" class="form-control" step="0.01" id="totalafterdisc" readonly placeholder="Total" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;" value="{{$challan_master[0]->Total}}">
                                        </div>
                                    </div>
                                    <div class="form-group mt-1">
                                        <label>Tax: &nbsp;</label>
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" id="taxpercentage" name="Taxpercentage" placeholder="tax %" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;" value="{{$challan_master[0]->TaxPer}}">

                                            <span class="input-group-text bg-light">{{session::get('Currency')}}</span>

                                            <input type="text" name="TaxpercentageAmount" class="form-control" id="taxpercentageAmount" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;" value="{{$challan_master[0]->Tax}}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group mt-1">
                                        ...
                                        <div class="input-group">
                                            <span class="input-group-text bg-light">{{session::get('Currency')}}</span>
                                            <input type="number" name="Shipping" class="form-control" step="0.01" id="shipping" placeholder="Grand Total" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;" value="{{$challan_master[0]->Shipping}}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group mt-1">
                                        ...
                                        <div class="input-group">
                                            <span class="input-group-text bg-light">{{session::get('Currency')}}</span>
                                            <input type="number" name="Grandtotal" class="form-control" step="0.01" id="grandtotal" placeholder="Grand Total" readonly onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;" value="{{$challan_master[0]->GrandTotal}}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group mt-1 d-none">
                                        ...
                                        <div class="input-group">
                                            <span class="input-group-text bg-light">{{session::get('Currency')}}</span>
                                            <input type="number" class="form-control" id="amountPaid" name="amountPaid" placeholder="Amount Paid" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;" step="0.01" value="{{$challan_master[0]->Paid}}">
                                        </div>
                                    </div>
                                     ...
                                     <div class="form-group mt-1 d-none">
                                        ...
                                        <div class="input-group">
                                            <span class="input-group-text bg-light">{{session::get('Currency')}}</span>
                                            <input type="number" class="form-control amountDue" name="amountDue" id="amountDue" placeholder="Amount Due" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;" step="0.01" value="{{$challan_master[0]->Balance}}">
                                        </div>
                                    </div>
