...
<!-- enctype="multipart/form-data" -->
  <form action="{{URL('/PurchasePaymentSave')}}" enctype="multipart/form-data" method="post" class="custom-validation"> {{csrf_field()}} 
...
<div><button type="submit" class="btn btn-danger  float-right  ">Save </button>
