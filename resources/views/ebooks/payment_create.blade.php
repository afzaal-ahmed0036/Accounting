...
<!-- enctype="multipart/form-data" -->
  <form action="{{URL('/PaymentSave')}}" enctype="multipart/form-data" method="post" class="custom-validation"> 
...
<div class="col-md-8">
  ...
  <span class="input-group-text"><i class="mdi mdi-calendar"></i></span>
        ...
        <div class="row mb-4">
                   ...
                   <div class="col-sm-9">
                   <input type="text" class="form-control" id="horizontal-firstname-input" name="PaymentMasterID" value="{{$payment[0]->PaymentMasterID}}" readonly="" required="">
                   </div>
                   </div>   
   ...
   <div class="row mb-4">
                   ...
                   <div class="col-sm-9">
                      <select name="PaymentMode" id="" class="form-select" required="">
     ...
     <div class="row mb-4">
                   ...
                   <div class="col-sm-9">
                   <input type="text" class="form-control" id="horizontal-firstname-input" name="ReferenceNo" required="">
                   </div>
                   </div> 
