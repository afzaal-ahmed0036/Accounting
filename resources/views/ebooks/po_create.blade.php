...
<div class="main-content">
    <div class="page-content">
        <div class="container-fluid">
            ...
            <form action="{{URL('/PurchaseOrderSave')}}" method="post" class="custom-validation">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="col-12">
                                    <div class="mb-1 row">
                                        ...
                                        <div class="col-sm-9">
                                            <div id="invoict_type"> <input type="text" name="PON" autocomplete="off" class="form-control" value="PON-{{$vhno[0]->VHNO}}" required=""></div>
                                ...
                                <div class="col-12">
                                    <div class="mb-1 row ">
                                        <div class="col-sm-3">
                                            <label class="col-form-label text-danger" for="contact-info">Delivery Date</label>
                                        </div>
                                        <div class="col-sm-9">
                                ...
                                <table>
                                    ...
                                    <tbody>
                                        <tr class="p-3">
                                            ...
                                            <td>
                                                <input type="number" name="Qty[]" id="Qty_1" class=" form-control changesNo" autocomplete="off" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;" step="0.01" value="1" required="">
                                            </td>

                                            <td>
                                                <input type="number" name="Price[]" id="Price_1" class=" form-control changesNo" autocomplete="off" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;" step="0.01" required="">
                                            </td>
                                            ...
                                            <td>
                                                <input type="number" name="TaxVal[]" id="TaxVal_1" class=" form-control totalLinePrice2" autocomplete="off" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;" step="0.01" required="">
                                            </td>

                                            <td>
                                                <input type="number" name="ItemTotal[]" id="ItemTotal_1" class=" form-control totalLinePrice " autocomplete="off" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;" step="0.01" required="">
                                            </td>
                                        </tr>
...
<script>
    ...
    $(".addmore").on('click', function() {
        ...
        html += '<td><input type="text" name="Qty[]" id="Qty_' + i + '" class="form-control changesNo " autocomplete="off" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;" value="1" required=""></td>';
        ...
        html += '<td><select name="Tax[]" id="TaxID_' + i + '" class="form-control changesNo exclusive_cal" required=""><?php foreach ($tax as $key => $valueX1) : ?><option value="{{$valueX1->TaxPer}}">{{$valueX1->Description}}</option><?php endforeach ?></select></td>';


        html += '<td><input type="number" name="TaxVal[]" id="TaxVal_' + i + '" class=" form-control totalLinePrice2 "autocomplete="off" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;" step="0.01 required="""></td>';




        html += '<td><input type="text" name="ItemTotal[]" id="ItemTotal_' + i + '" class="form-control totalLinePrice" autocomplete="off" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;" required=""></td>';
