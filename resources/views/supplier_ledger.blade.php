  ...
  <div class="card">
      <div class="card-body">
          ...
          <form action="{{URL('/SupplierLedger1')}}" method="post" name="form1" id="form1"> {{csrf_field()}} 
             ...
             <div class="mb-1">
                 <select name="SupplierID" id="" class="select2 form-select" id="select2-basic" required="">
...
container="#datepicker21" data-provide="datepicker" data-date-autoclose="true" value="{{date('Y-m-d')}}" required="">
...
container="#datepicker22" data-provide="datepicker" data-date-autoclose="true" value="{{date('Y-m-d')}}" required="">
  <span class="input-group-text"><i class="mdi mdi-calendar"></i></span>
    </div>
              </div>
      ...
      <div class="card-footer bg-light">
        <button type="submit" class="btn btn-success w-lg float-right" id="online">Submit</button>
         <button type="submit" class="btn btn-secondary w-lg float-right" id="SupplierBillLedger2PDF">Supplier Ledger with Bill Details</button>
       </div>
  </div>
   </form>
  </div>
...
<script>
 ...
 $('#SupplierBillLedger2PDF').click(function(){
        $("#form1").removeAttr("target");
     $("#form1").removeAttr("action");
   $('#form1').attr('action', '{{URL("/SupplierBillLedger2PDF")}}');
