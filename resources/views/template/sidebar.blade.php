            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <li>
                    <a href="javascript: void(0);" class="has-arrow waves-effect">
                        ...
                        <span key="t-ecommerce">Production</span>
                    </a>
                    <ul class="sub-menu" aria-expanded="false">
                        <li> <a href="{{ URL('/Project/Index') }}" key="t-products">Project List</a></li>
                        <li> <a href="{{ URL('/Raw/Materials') }}" key="t-products">Raw Materials</a></li>
                        <li> <a href="{{ URL('/Products') }}" key="t-products">Products</a></li>
                        <li> <a href="{{ URL('/Production/Logs') }}" key="t-products">Production Logs</a></li>
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        ...
                        <li> <a href="{{ URL('/Employee') }}" key="t-products">Employee</a></li>
                        {{-- <li> <a href="{{ URL('/Teams') }}" key="t-products">Teams</a></li> --}}
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        ...
                        <li><a key="t-products" href="{{ URL('/ExpenseReport') }}">Expense Report</a></li>
                    </ul>
                </li>

                <li>
                    <a href="javascript: void(0);" class="has-arrow waves-effect">
                        <i class="mdi mdi-folder-outline font-size-18  me-2"></i>
