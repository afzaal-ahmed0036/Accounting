    ...
    <div class="main-content">
        <div class="page-content">
            <div class="container-fluid">
                ...
                <form action="{{ URL('/SaleInvoiceSave') }}" method="post" class="custom-validation">
                                        ...
                                        <div class="mb-1 row">
                                            ...
                                            <div class="col-sm-9">
                                                <select name="InvoiceType" id="InvoiceType" class="form-select">
                                                    ...
                                                    <option value="{{ $value->InvoiceType }}">{{ $value->InvoiceType }}
                                                    </option>
                                                    <?php endforeach ?>
                                                </select>
                                            ...
                                            <tr class="p-3">
                                                ...
                                                <td valign="top">
                                                    <input type="number" name="Price[]" id="Price_1"
                                                        ...
                                                        onkeypress="return IsNumeric(event);" ondrop="return false;"
                                                        onpaste="return false;" step="0.01" required="">
                                                </td>
                                                <td valign="top">
                                            ...
                                            <label class="col-form-label" for="password">Salesperson </label>
                                                            ...
                                                            <div class="col-sm-9 input-group">
                                                                <select name="DiscountType[]" id="DiscountType_1"
                                                                    ...
                                                                    <option value="2">{{ session::get('Currency') }}
                                                                    </option>
                            ...
                            <div class="row mt-4">
                                ...
                                <div class="col-lg-8 col-12  ">
                                    ...
                                    <div class="mt-2"><button type="submit" class="btn btn-success w-md float-right"
                                            return true; else return false;">Save</button>
                                        ...
                                        <div class="form-group mt-1">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="number" name="Grandtotal" id="Grandtotal"
                                                    class="form-control parsley-error" step="0.01" id="grandtotal"
    ...
    <script>
        ...
        $(".addmore").on('click', function() {
            ...
            html += '<td><select name="ItemID0[]" id="ItemID0_' + i +
                ...
                i +
                ');" required=""> <option value="">select</option>}@foreach ($items as $key => $value) <option value="{{ $value->ItemID }}|{{ $value->Percentage }}">{{ $value->ItemCode }}-{{ $value->ItemName }}-{{ $value->Percentage }}</option>@endforeach</select><input type="hidden" name="ItemID[]" id="ItemID_' +
                i +
            ...
            html += '<td valign="top"><input type="text" name="Qty[]" id="Qty_' + i +
                '" class="form-control changesNo QtyTotal" autocomplete="off" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;" value="1" required=""></td>';

            html += '<td valign="top"><input type="text" name="Price[]" id="Price_' + i +
                '" class="form-control changesNo " autocomplete="off" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;" required=""></td>';
            html += '<td valign="top"><div class="input-group"><input type="text" name="Discount[]" id="Discount_' +
                i +
                '" class=" form-control changesNo" autocomplete="off" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;" step="0.01" value="0" required=""><span ><div class="col-sm-9 input-group"><select name="DiscountType[]" id="DiscountType_' +
                i +
            ...
            html += '<td  valign="top"> <input type="number" name="Gross[]" id="Gross_' + i +
                '" class=" form-control changesNo" autocomplete="off" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;" step="0.01" required="">  </td>';

            html += '<td  valign="top"><select name="Tax[]" id="TaxID_' + i +
                '" class="form-control changesNo exclusive_cal bg-light" required=""><?php foreach ($tax as $key => $valueX1) : ?><option value="{{ $valueX1->TaxPer }}">{{ $valueX1->Description }}</option><?php endforeach ?></select></td>';


            html += '<td  valign="top"><input type="number" name="TaxVal[]" id="TaxVal_' + i +
                '" class=" form-control totalLinePrice2 "autocomplete="off" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;" step="0.01" value="0" required=""></td>';




            html += '<td  valign="top"><input type="text" name="ItemTotal[]" id="ItemTotal_' + i +
                '" class="form-control totalLinePrice" autocomplete="off" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;" required=""></td>';
