...
Route::group(['middleware' => ['CheckAdmin']], function () {
    ...
    // -------------------------------------Project Routes----------------------------
    Route::get('Project/Index', [ProductionController::class, 'projectIndex']);
    Route::get('Project/Create', [ProductionController::class, 'projectCreate']);
    Route::post('Project/Save', [ProductionController::class, 'projectSave']);
    Route::get('ProjectView/{id}', [ProductionController::class, 'projectView']);
    Route::get('ProjectPDF/{id}', [ProductionController::class, 'projectPDF']);
    Route::get('ProjectEdit/{id}', [ProductionController::class, 'projectEdit']);
    Route::post('Project/Update', [ProductionController::class, 'projectUpdate']);
    Route::get('ProjectDelete/{id}', [ProductionController::class, 'projectDelete']);

    Route::get('Employee', [EmployeeController::class, 'Employee']);
    Route::post('EmployeeSave', [EmployeeController::class, 'EmployeeSave']);


    Route::get('Raw/Materials', [ProductController::class, 'rawMaterials']);
    Route::post('RawMaterialSave', [ProductController::class, 'rawMaterialSave']);
    Route::get('RawMaterialEdit/{id}', [ProductController::class, 'rawMaterialEdit']);
    Route::post('RawMaterialUpdate/', [ProductController::class, 'rawMaterialUpdate']);
    Route::get('RawMaterialDelete/{id}', [ProductController::class, 'rawMaterialDelete']);
    ...
    Route::get('Product/View/{id}', [ProductController::class, 'productShow']);
    ...
    Route::post('getMaterialDetails', [ProductController::class, 'getMaterialDetails']);
    Route::post('getProductDetails', [ProductController::class, 'getProductDetails']);
